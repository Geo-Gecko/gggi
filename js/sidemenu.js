...
//	newCode += "<div class=\"col-xs-2 col-sm-2 col-md-2 col-lg1-2\" data-side=\""+side+"\">\n"+ oldCode+" </div>\n";
		...
		newCode += "	<span style = 'left:20px; color: white;' class=\"glyphicon glyphicon-chevron-right\"><!--&nbsp;--></span> <span style = 'color: white;'  class=\"glyphicon glyphicon-chevron-left\"><!--&nbsp;--></span>\n";
		newCode += "</div>\n";
