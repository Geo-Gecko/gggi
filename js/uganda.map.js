...
//    }
    ...
    var opacity = 0.7;
      ...
      $(".toggler").css("height",height+25);
        // $("#right").find(".toggler").append("<div id='logo' style=\"position: relative; bottom: calc(-100% + 120px); left: -40px;\">\n" +
        //     "                    <a href=\"https://www.geogecko.com/\" target=\"_blank\">\n" +
        //     "                        <img src=\"./data/Logo_full_no_text.svg\" alt=\"Geo Gecko\" style=\"width:10em; height:4em; margin-left: -8em;\">\n" +
        //     "                    </a>\n" +
        //     "                    <a href=\"https://www.geogecko.com/\" target=\"_blank\">\n" +
        //     "                        <img src=\"./data/logo-netherlands_embassy.png\" alt=\"Geo Gecko\" style=\"width:10em; height:4em; margin-left: -8em;\">\n" +
        //     "                    </a>\n"+
        //     "                    <a href=\"https://www.geogecko.com/\" target=\"_blank\">\n" +
        //     "                        <img src=\"./data/gggi_green.png\" alt=\"Geo Gecko\" style=\"width:10em; height:4em; margin-left: -8em;\">\n" +
        //     "                    </a>\n" +
        //     "            </div>");
...
//           window.open("https://www.geogecko.com", "_blank");
//       })
...
country = L.geoJson(ugandaGeoJson)
   ...
   setTimeout(function(){
       ...
       map.setView({lat: -0.570, lng: 30.570 });
       map.setZoom(zoom);
       setTimeout(function(){  
          map.setView({lat: -0.570, lng: 30.570 },zoom+0.8,{pan: {animate: true,duration: 1.5},zoom: {animate: true} });
